...
// Map icons to product IDs (for future use)
const getProductIcon = (productId) => {
  const icons = {
    'ai-smart-gate-enterprise': <FaEye className="text-lg" />
  };
  return icons[productId] || <FaCube className="text-lg" />;
};
...
return (
    <div className="w-80 h-screen bg-gradient-to-b from-gray-900 to-gray-950 border-r border-gray-800/50 flex flex-col">
      ...
      {/* Categories List - No Scroll Needed */}
          ...
          {data.categories.map((category) => (
            <button
              ...
              onClick={() => {
                ...
                // Auto-select the first product when category is clicked
